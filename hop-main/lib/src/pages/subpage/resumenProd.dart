...
import 'package:hopapp/src/provider/resumeProvider.dart';
import 'package:hopapp/src/utils/responsive.dart';
import 'package:qr_flutter/qr_flutter.dart';

ResumeProvider resumeProv = new ResumeProvider();

class ResumenCompras extends StatefulWidget {
  @override
  State<ResumenCompras> createState() => ResumenComprasState();
}

class ResumenComprasState extends State<ResumenCompras> {
  @override
